...
<body>
    ...
    <div id="intro-container">
        <div id="intro-wrapper">
            <h1 id="intro-heading">Creating a Project</h1>
        </div>
    </div>
    <div id="content-container">
        <div id="content-blog-wrapper">
            <form action="addprojectHandle.php" method="post">
                <div class="start-blog-container">
                    ...
                    <input type="text" name="imagepath" id="edit-imagepath" placeholder="pics/... Path to Pic">
                    <hr>
